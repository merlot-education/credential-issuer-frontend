...
export const environment = {
  production: false,
  orgasAPI: 'https://api.demo.merlot-education.eu/organisations/?page=0&size=50',
  ...
  invitationUrlApi:
    'https://ocm.demo.merlot-education.eu/connection/v1/invitation-url?alias=trust',
  ...
  connectionApi:
    'https://ocm.demo.merlot-education.eu/connection/v1/connections',
  ...
  createCredentialApi:
    'https://ocm.demo.merlot-education.eu/attestation/v1/create-offer-credential',
  ...
  credentialApi:
    'https://ocm.demo.merlot-education.eu/attestation/v1/credential',
  // credentialDefinitionId:
  //   '7KuDTpQh3GJ7Gp6kErpWvM:3:CL:90163:MerlotFederationLoginLongerWith240',
  credentialDefinitionId:
    'UaT2udeT53Tr1n6itV46Z:3:CL:1047695:MerlotLoginDemo7102024CredDefId',
};
